...
define gui.choice_button_width = 588
...
define gui.slot_button_width = 206
...
define config.thumbnail_width = 191
...
define gui.history_text_width = 551
...
define gui.nvl_thought_width = 581
define gui.nvl_thought_xalign = 0.0

## The position of nvl menu_buttons.
define gui.nvl_button_xpos = 335
...
init python:
    ...
    def small():
        ...
        gui.textbox_height = 179
        gui.name_xpos = 60
        gui.dialogue_xpos = 67
        gui.dialogue_width = 819

        ## Change the size and spacing of various things.
        gui.slider_size = 27

        gui.choice_button_width = 923
        ...
        gui.nvl_name_width = 227
        gui.nvl_name_xpos = 242

        gui.nvl_text_width = 681
        gui.nvl_text_xpos = 257
        gui.nvl_text_ypos = 4

        gui.nvl_thought_width = 923
        gui.nvl_thought_xpos = 15

        gui.nvl_button_width = 923
